  ...
  return (
    <div>
          ...
          <div className="swiper-content h-full flex lg:gap-16 px-4 items-center justify-center">
            <div>
              ...
              <p className="lg:max-w-[500px] py-5 opacity-0 text-center lg:text-start  ">
                ...
                caps, and their fierce boss Tommy Shelby, who means to move up
                in the world.
              </p>
              <div className="flex gap-5 py-5 w-fit mx-auto lg:mx-0">
                <button
                  className="bg-red-700 border-2 opacity-0 swiper-btn-1 border-red-700 rounded-full px-5 py-2"
                  onClick={() => setModal(1)}
                >
                  Watch now
                </button>
                <button
                  className="border-2 opacity-0 hover:border-red-700 hover:bg-white hover:text-red-700 border-white rounded-full px-5 py-2"
                  onClick={() => setModal(1)}
                >
                  Watch trailer
                </button>
          ...
          <div className="swiper-content h-full flex lg:gap-16 px-4 items-center justify-center">
            <div>
              ...
              <p className="lg:max-w-[500px] py-5 opacity-0 text-center lg:text-start  ">
                ...
                ex-girlfriend Jane Foster, who now wields Mjolnir as the Mighty
                Thor. Together they embark upon a harrowing cosmic adventure to
                uncover the mystery of the God Butcher’s vengeance and stop him
      ...
      {modal == 1 ? (
        ...
        >
          <div
            className="text-xl text-white flex pb-2 cursor-pointer"
            onClick={() => setModal(0)}
          >
